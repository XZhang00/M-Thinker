...
split = 64
cons_acc_num_constraint = 8  

ft_data_number = 3000

for lang in ["fr", "pt", "th", "ja", "ko"]:

    predict_path = "data/predict-other_data-1.5B-after-Iter1/M-Thinker-1.5B-Iter1"
    # predict_path = "data/predict-other_data-7B-after-Iter1/M-Thinker-7B-Iter1"
    cnt = 0
    acc = 0
    acc_all = 0
    cons_acc = 0
    ...
    for part in range(split):
        try:
            ...
            for item in cur_predict:
                ...
                if item["cons_acc_num"] > 0 and item["cons_acc_num"] < cons_acc_num_constraint: 
                    cons_acc += 1
...
save_dir = "data/M-Thinker-1.5B-RL-Iter2-data-ori"
