...
MODEL_NAME=M-Thinker-1.5B-Iter1

DATA_PATH=data/predict-other_data-1.5B-after-Iter1


# ### for 7B
# MODEL_PATH=XueZhang-bjtu/M-Thinker-7B-Iter1
# MODEL_NAME=M-Thinker-7B-Iter1

# DATA_PATH=data/predict-other_data-7B-after-Iter1
