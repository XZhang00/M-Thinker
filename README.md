...
| :-- | :-- | :-- |
<img src="image.png" alt="huggingface" width="16"> <a href="https://huggingface.co/XueZhang-bjtu/M-Thinker-7B-Iter2">M-Thinker-7B-Iter2</a> (👍👍) &emsp; &emsp; &emsp; &emsp; |  <img src="image.png" alt="huggingface" width="16"> <a href="https://huggingface.co/XueZhang-bjtu/M-Thinker-7B-Iter1">M-Thinker-7B-Iter1</a> |  <img src="image.png" alt="huggingface" width="16">  [M-Thinker-7B-RL-Iter2-data](https://huggingface.co/datasets/XueZhang-bjtu/M-Thinker-7B-RL-Iter2-data) 
