...
PRETRAIN_MODEL=your_path/Models/deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B
...
OUTPUT_DIR=$ROOT_DIR/checkpoints/DeepSeek-R1-Distill-Qwen-1.5B-cold_SFT/${EXP_TAG}
...
nohup your_path/anaconda3/envs/lf_train/bin/deepspeed \
    ...
    --deepspeed $CODE_DIR/examples/deepspeed/ds_z2_config.json \
    --stage sft \
    --do_train \
