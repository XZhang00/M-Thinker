...
if [ $RANK -eq 0 ]; then
    ...
    exp_name=M-Thinker-7B-RL-Iter1-lr${lr}_kl_loss_coef${kl_loss_coef}
    proj_name=DeepSeek-R1-Distill-Qwen-7B-GRPO_cold_SFT

    v1_train_path=data/M-Thinker-7B-RL-Iter1-data/train.parquet
    v1_test_path=data/M-Thinker-7B-RL-Iter1-data/test.parquet
